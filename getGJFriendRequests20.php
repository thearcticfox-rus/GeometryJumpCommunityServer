...
foreach($result as &$request) {
	...
	$query = "SELECT userName, accountID, icon, color1, color2, iconType FROM accounts WHERE accountID = :requester";
	$query = $db->prepare($query);
	...
	$reqstring .= "1:".$user["userName"].":2:".$user["accountID"].":9:".$user["icon"].":10:".$user["color1"].":11:".$user["color2"].":14:".$user["iconType"].":16:".$extid.":32:".$request["ID"].":35:".$request["comment"].":41:".$request["isNew"].":37:".$uploadTime."|";
